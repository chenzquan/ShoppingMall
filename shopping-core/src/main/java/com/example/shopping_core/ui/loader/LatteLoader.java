...
import com.example.shopping_core.util.dimens.DimenUtil;
...
public class LatteLoader {
    ...
    private static final int LOADER_SIZE_SCALE = 8; //缩小倍数
    private static final int LOADER_OFFSET_SCALE = 10; //偏移量

    private static final ArrayList<AppCompatDialog> LOADERS = new ArrayList<>(); //用来存储dialog 可以方便地关闭
